  ...
  <div class="ReservationList container-fluid py-4">
    ...
    <div class="search">
      ...
      >
        ...
        <div class="search-wrap">
          <!-- キャストラジオ -->
          <fieldset
            class="field-group radio-cast radio-items"
        ...
        <div class="btn-wrap">
          ...
          <button
            type="button"
            class="btn btn-dark btn-reset"
            @click="resetForm"
          >
            リセット
          </button>
          <button
            class="btn btn-dark btn-new"
    ...
    <div class="list">
      <table class="table table-bordered table-hover align-middle table-striped">
        ...
        <tbody>
          <tr
            v-for="r in rows.filter(Boolean)"
            :key="r.id"
          ...
          >
            ...
            <td class="fw-bold">
              ¥{{ (r.card_amount ?? 0).toLocaleString() }}
            </td>
            <td class="fw-bold">
