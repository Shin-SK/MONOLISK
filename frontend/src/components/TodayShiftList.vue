...
<template>
  <div class="today-shift-list">
    <h5 class="mb-3">今日の出勤者</h5>

    <template v-if="list.length">
      <ul class="list-group">
        <li v-for="p in list" :key="p.id" class="list-group-item d-flex align-items-center gap-2">
          <img :src="p.photo_url || '/img/cast-default.png'"
          ...
          <span v-if="p.is_checked_in" class="badge bg-success ms-2">IN</span>
        </li>
      </ul>
    </template>
